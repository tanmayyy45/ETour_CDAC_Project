            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-2">
                <nav className="space-y-1">
                  <NavLink to={`/tours/${catmasterId}`} end replace className={navLinkClass}>
                    Overview
                  </NavLink>
                  <NavLink to="itinerary" replace className={navLinkClass}>
                    Day-wise Itinerary
                  </NavLink>
                  <NavLink to="cost" replace className={navLinkClass}>
                    Cost Details
                  </NavLink>
                  <NavLink to="departures" replace className={navLinkClass}>
                    Departure Dates
                  </NavLink>
                </nav>
              </div>
